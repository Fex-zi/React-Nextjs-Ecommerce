                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="md:py-8">
                        <div className="mb-2 md:mb-3">
                            ...
                            <h2 className="text-2xl font-bold text-gray-800 lg:text-3xl">{data.name}
                            </h2>
                        </div>
                        <div className="mb-6 flex items-center gap-3 md:mb-10">
                            ...
                            <span className="text-sm text-gray-500 transition duration-100">56 Rating
                            </span>
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-6 flex items-center gap-2 text-gray500">
                            <Truck className="w-6 h-6"/>
                            <span className="text-sm"> 2-4 Days Shipping</span>
                        </div>
                        <div className="flex gap-2.5">
                            <AddToBag currency="USD" description={data.description}
                             image={data.images[0]} 
                             name={data.name} 
                             price={data.price}
                              key={data._id}
